...
- [ ] Repo đủ: README (thành viên + phân công có tên) · spec.md · demo-slides.pdf · libs/ · evals/ (golden set + các lượt chạy) · ../validation/ (feedback log) · reflection/ (mỗi người 1 file)
